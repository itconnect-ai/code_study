...
<!-- Sync Impact Report: constitution.md populated from my_constitution.md. All 11 principles mapped. Governance section populated. Version set to 1.0.0. No template updates required — all templates reference constitution generically. -->
